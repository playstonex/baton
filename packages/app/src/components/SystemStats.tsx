...
export function SystemStats() {
  ...
  return (
    <Card padding={false} className="p-6">
      ...
      <div className="mb-6 flex flex-wrap items-center gap-x-6 gap-y-2 rounded-lg bg-gray-50 px-6 py-4 dark:bg-gray-800/50">
        ...
        <span className="text-xs text-gray-500">{stats.platform}</span>
        <span className="text-gray-200 dark:text-gray-700">·</span>
        <span className="text-xs text-gray-500">Uptime: {formatUptime(stats.uptime)}</span>
        <span className="text-gray-200 dark:text-gray-700">·</span>
        <span className="text-xs tabular-nums text-gray-500">Load: {stats.loadAvg.map((n) => n.toFixed(2)).join(', ')}</span>
      </div>
  ...
  return (
    <div>
      <div className="mb-2.5 flex items-center justify-between">
        ...
        <span className="font-mono text-[11px] tabular-nums text-gray-400">{value}</span>
      </div>
